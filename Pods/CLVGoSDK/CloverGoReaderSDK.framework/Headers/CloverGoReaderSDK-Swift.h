...
SWIFT_MODULE_NAMESPACE_PUSH("CloverGoReaderSDK")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) CardReader * _Nonnull sharedInstance;)
+ (CardReader * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (NSDictionary<NSString *, CardReaderInfo *> * _Nonnull)getConnectedReaders SWIFT_WARN_UNUSED_RESULT;
...
- (void)startTransaction:(NSInteger)amountInCents;
- (void)endTransaction;
